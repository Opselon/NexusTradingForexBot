...
def publish_bundle(api, bundle_dir, version: str) -> None:
    ...
    api.upload("official-model-stable", [Path(bundle_dir) / "channel-manifest.json"], clobber=True)
...
def main(argv: list[str] | None = None) -> int:
    """Validate publication requests; unsupported operations fail explicitly."""
    import argparse
    import sys
