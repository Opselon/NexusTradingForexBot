...
## BUG-266 - Both web consoles dead-end UNAUTHORIZED on first navigation; React /alt never bootstraps; doctor probes a dead :8080 / phantom /api/health (Hermes, 2026-09-13)
