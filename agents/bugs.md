...
## BUG-285 - Review follow-up on merged #199 (code-review, 2026-09-15): BUG-279 weekend predicate RESTATED the calendar window + a second sentinel-file pair reached main ('the', 'min_samples_to_reject' tracked by 94ecf2c7 INSIDE the wave)
