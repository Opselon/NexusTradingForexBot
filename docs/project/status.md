...
| :--- | :--- | :--- |
| Version | **9.0.13** (semver, single source `pyproject.toml`) | release pipeline stamps every artifact |
| Release | **Published** (v9.0.0 → v9.0.13 tags; hardened pipeline: SHA-256, manifests, SBOM) | GitHub Releases |
