...
- [ML-QA-003](tasks/ML-QA-003.md) — Test Determinism Census & Push-Gate Exposure Roster `[P2 | DONE (PR #392) | AGENT-QA]`
- [ML-QA-004](tasks/ML-QA-004.md) — Push-Gate Timing Determinism Remediation (injected clock + CPU-time budgets) `[P2 | DONE (PR pending) | AGENT-QA]`
