...
- [ML-QA-011](tasks/ML-QA-011.md) — Push-Gate Wall-Clock Determinism: Shadow70 Safety Suite (roster recount #2, one frozen instant + tmp_path + CPU-budget flush wait, spec 13/14 idempotency now provable) `[P2 | DONE (PR pending) | AGENT-QA]`
