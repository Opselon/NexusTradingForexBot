...
- **Delivery:** PR #402 (combined with ML-QA-004, run 37 — the two deliveries
  were recomposed onto current main as one linear branch after PR #401's
  rebased base produced a dead link to this file in `docs/ml-system/TASK_BOARD.md`).
