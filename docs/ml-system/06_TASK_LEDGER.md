...
| `ML-LABEL-002` | C: Labeling | P1 | Sample Uniqueness & Overlap Anti-Leakage | **BLOCKED** | `AGENT-LABEL` | NO | `ML-LABEL-001` | `PARALLEL_SAFE` |
...
| `ML-VAL-001` | G: Validation | P1 | Purged Walk-Forward Monotonicity & Embargo | **BLOCKED** | `AGENT-ML-VALIDATION` | NO | `ML-DATA-002` | `PARALLEL_SAFE` |
...
| `ML-UI-001` | L: UX & Integration | P1 | End-to-End Model UX & CLI Verification (Train/Predict/Trust) | **IMPLEMENTED** | `AGENT-UI` | NO | None | `PARALLEL_SAFE` |
