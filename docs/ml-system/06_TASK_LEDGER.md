...
| `ML-BT-001` | I: Backtest | P1 | Trading Quality Metrics vs Classification | **DONE** (PR #316, `agent/backtest/ml-bt-001`) | `AGENT-BACKTEST` | NO | `ML-VAL-001`, `ML-VAL-003` | `PARALLEL_SAFE` |
