...
| `ML-QA-003` | L: CI/CD | P2 | Test Determinism Census & Push-Gate Exposure Roster | **DONE** (PR #392, `61fd0010`) | `AGENT-QA` | NO | `ML-CI-002` | `PARALLEL_SAFE` |
| `ML-QA-004` | L: CI/CD | P2 | Push-Gate Timing Determinism Remediation (injected clock + CPU-time budgets) | **DONE** | `AGENT-QA` | NO | `ML-QA-003` | `PARALLEL_SAFE` |
