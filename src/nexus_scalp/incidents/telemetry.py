...
ENGINE_EVENT_MAP: dict[str, tuple[str, str]] = {
    ...
    # OBS-PERF-RESILIENCE: hot-path DEGRADED->BLOCKED transitions must be
    # visible as first-class incidents, never only as log lines.
    "INFERENCE_BLOCKED_70D_ASSEMBLY": ("BLOCKED_INFERENCE", "MEDIUM"),
    "SCALER_DEGRADED": ("MODEL_CONTRACT_MISMATCH", "HIGH"),
    "INFERENCE_LATENCY_REGRESSION": ("SLOW_INFERENCE", "MEDIUM"),
}
