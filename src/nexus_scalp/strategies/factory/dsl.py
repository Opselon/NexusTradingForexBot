...
_FAMILY_TEMPLATES: dict[StrategyFamily, dict[str, Any]] = {
    StrategyFamily.TREND_FOLLOWING: {
        ...
        "entry": {"logic": "pullback_in_trend", "confirmation": ["structure_break"]},
        "filters": [{"feature": "ema_fast_minus_slow", "op": "gt", "value": 0.0}],
        "exit": {"mode": "trailing", "factor": 2.0},
    },
    StrategyFamily.MEAN_REVERSION: {
        "context": {"volatility_filter": {"use": True}, "range_state": {"use": True}},
        "entry": {"logic": "overshoot_reversion", "confirmation": ["rsi_extreme"]},
        "filters": [{"feature": "rsi_14", "op": "lt", "value": 30.0}],
        "exit": {"mode": "target", "rr": 2.0},
    },
    StrategyFamily.BREAKOUT: {
        "context": {"volatility_filter": {"use": True}, "session_filter": {"use": True}},
        "entry": {"logic": "range_break", "confirmation": ["volume_surge"]},
        "filters": [{"feature": "atr_14", "op": "gt", "value": 0.0}],
        "exit": {"mode": "fixed_rr", "rr": 2.5},
    },
    StrategyFamily.REVERSAL: {
        "context": {"htf_bias": {"use": True}, "session_filter": {"use": True}},
        "entry": {"logic": "exhaustion_reversal", "confirmation": ["wick_rejection"]},
        "filters": [{"feature": "rsi_14", "op": "gt", "value": 70.0}],
        "exit": {"mode": "target", "rr": 2.0},
    },
    StrategyFamily.MOMENTUM: {
        "context": {"trend_state": {"use": True}, "volatility_filter": {"use": True}},
        "entry": {"logic": "momentum_continuation", "confirmation": ["momentum_strength"]},
        "filters": [{"feature": "price_change_pct", "op": "gt", "value": 0.0}],
        "exit": {"mode": "chandelier", "factor": 3.0},
    },
    StrategyFamily.VOLATILITY_EXPANSION: {
        "context": {"volatility_filter": {"use": True}},
        "entry": {"logic": "volatility_expansion_break", "confirmation": ["atr_expansion"]},
        "filters": [{"feature": "atr_14", "op": "gt", "value": 0.0}],
        "exit": {"mode": "fixed_rr", "rr": 2.0},
    },
    StrategyFamily.VOLATILITY_CONTRACTION: {
        "context": {"volatility_filter": {"use": True}},
        "entry": {"logic": "squeeze_break", "confirmation": ["bollinger_squeeze"]},
        "filters": [{"feature": "atr_14", "op": "lt", "value": 0.5}],
        "exit": {"mode": "target", "rr": 2.0},
    },
    StrategyFamily.LIQUIDITY_SWEEP: {
        "context": {"liquidity": {"use": True}, "session_filter": {"use": True}},
        "entry": {"logic": "liquidity_sweep_reversal", "confirmation": ["sweep_state"]},
    ...
    StrategyFamily.SESSION: {
        ...
        "entry": {"logic": "session_break", "confirmation": ["session_high_low"]},
        "filters": [{"feature": "session_phase", "op": "eq", "value": 1.0}],
        "exit": {"mode": "fixed_rr", "rr": 2.0},
    },
    StrategyFamily.MULTI_TIMEFRAME: {
        "context": {"htf_bias": {"use": True}, "timeframes": ["M1", "H1"]},
        "entry": {"logic": "htf_aligned_entry", "confirmation": ["htf_structure"]},
        "filters": [{"feature": "htf_trend_alignment", "op": "eq", "value": 1.0}],
