...
def build_position_decision_payload(req: PositionDecisionRequest) -> dict[str, Any]:
    ...
    return {
        ...
        "requested_output": {
            ...
            "tp": {"recommendation": "string", "candidate_price": "float|null", "confidence": "float"},
            "sl": {"recommendation": "string", "candidate_price": "float|null", "risk_change": "float", "confidence": "float"},
            "reason_codes": ["string"],
            "warnings": ["string"],
        },
    }
