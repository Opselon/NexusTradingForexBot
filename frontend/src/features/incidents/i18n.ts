/**
 * i18n messages — scope: features/incidents
 ...
 *   "<key>": { fa: "...", de: "...", es: "...", ar: "..." },
 * - Key namespace: "incidents.<area>.<name>" (lowercase, dot-separated).
 * - en is identity: the English source string lives at the call site —
 *   t("incidents.x.y", "English source") — do NOT add `en` entries here.
