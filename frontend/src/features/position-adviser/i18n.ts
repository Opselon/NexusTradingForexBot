/**
 * i18n messages — scope: features/position-adviser
 ...
 *   "<key>": { fa: "...", de: "...", es: "...", ar: "..." },
 * - Key namespace: "position-adviser.<area>.<name>" (lowercase, dot-separated).
 * - en is identity: the English source string lives at the call site —
 *   t("position-adviser.x.y", "English source") — do NOT add `en` entries here.
