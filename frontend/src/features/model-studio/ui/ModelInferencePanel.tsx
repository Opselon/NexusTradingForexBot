              ...
              {predictData.layer_inspection && predictData.layer_inspection.length > 0 ? (
                <div className="table-wrap" style={{ maxHeight: 260 }}>
                  <table className="data-table">
                    <thead>
                      <tr>
                        <th>{t("model-studio.inference.th_layer", "Layer")}</th>
                        <th>{t("model-studio.inference.th_type", "Type")}</th>
                        <th>{t("model-studio.inference.th_shape", "Shape")}</th>
                        <th className="num">{t("model-studio.inference.th_l2", "L2 Norm")}</th>
                        <th className="num">{t("model-studio.inference.th_mean", "Mean")}</th>
                        <th className="num">{t("model-studio.inference.th_std", "Std")}</th>
                        <th style={{ textAlign: "center" }}>{t("model-studio.inference.th_zero", "Zero %")}</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center", marginBottom: 10 }}>
            ...
            {components70.length > 0 && (
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                ...
                <span className="badge neutral">{t("model-studio.inference.slots_badge", "{n} / 70 slots", { n: components70.length })}</span>
              </div>
            )}
          </div>
