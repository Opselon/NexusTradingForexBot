...
export const MESSAGES: FeatureMessages = {
  ...
  "trace.events.row_title": { fa: "{stage} @ {ts} · شماره {seq}{unmapped}{gap}", de: "{stage} @ {ts} · Seq {seq}{unmapped}{gap}", es: "{stage} @ {ts} · seq {seq}{unmapped}{gap}", ar: "{stage} @ {ts} · تسلسل {seq}{unmapped}{gap}" },
  ...
  "trace.inspector.f_actual_vs_required": { fa: "مقدار واقعی در برابر مقدار لازم", de: "actual vs required", es: "actual vs requerido", ar: "الفعلي مقابل المطلوب" },
  ...
  "trace.inspector.f_rejection_stage": { fa: "مرحله رد", de: "rejection stage", es: "fase de rechazo", ar: "مرحلة الرفض" },
  "trace.inspector.f_cause": { fa: "علت", de: "cause", es: "cause", ar: "السبب" },
  "trace.inspector.f_exec_status": { fa: "وضعیت اجرا", de: "execution status", es: "estado de ejecución", ar: "حالة التنفيذ" },
  "trace.inspector.f_order_id": { fa: "شناسه سفارش", de: "order_id", es: "order_id", ar: "معرّف الأمر" },
  "trace.inspector.f_gateway_reached": { fa: "دستیابی به دروازه", de: "gateway reached", es: "gateway alcanzado", ar: "تم الوصول للبوابة" },
  "trace.inspector.f_gateway": { fa: "دروازه", de: "gateway", es: "gateway", ar: "البوابة" },
  "trace.inspector.f_gateway_state": { fa: "وضعیت دروازه", de: "gateway state", es: "gateway state", ar: "حالة البوابة" },
  ...
  "trace.inspector.evidence_basis": { fa: "مبنای شواهد", de: "evidence basis", es: "base de evidencia", ar: "أساس الدليل" },
  ...
  "trace.inspector.selected_frame": { fa: "قاب انتخاب‌شده", de: "selected frame", es: "fotograma seleccionado", ar: "الإطار المحدد" },
