 ...
 *
 * i18n: status notes are (t) => string closures resolved at render, so a
 * language switch re-translates an already-visible note. Backend enum words
...
/** One command note: rendered with the ACTIVE language every time. */
type ProNote = { text: (t: TFunc) => string; err: boolean };
