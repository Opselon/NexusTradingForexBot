/**
 * i18n messages — scope: features/governance
 ...
 *   "<key>": { fa: "...", de: "...", es: "...", ar: "..." },
 * - Key namespace: "governance.<area>.<name>" (lowercase, dot-separated).
 * - en is identity: the English source string lives at the call site —
 *   t("governance.x.y", "English source") — do NOT add `en` entries here.
