  ...
  return (
    <div className="dbg-sec dbg-ops">
      <div className="l3-note warn dbg-safety">
        <b>Side-effect surface.</b> The simulation buttons below POST <span className="inline-mono">/api/simulation/tick</span>. The backend refuses the injection unless execution mode is
        SIMULATION/PAPER, and its refusal message is rendered verbatim — on a LIVE engine every button answers "refused", which is the correct, honest outcome.
      </div>
      <SimulationPanel />
      <TelegramWorkerPanel />
    </div>
