...
export const MESSAGES: FeatureMessages = {
  ...
  "shell.sidebar.landmark": { fa: "نوار کناری", de: "Seitenleiste", es: "Barra lateral", ar: "الشريط الجانبي" },
  "shell.sidebar.toggle_aria": { fa: "باز و بستن نوار کناری", de: "Seitenleiste umschalten", es: "Mostrar u ocultar la barra lateral", ar: "تبديل الشريط الجانبي" },
  "shell.topbar.aria": { fa: "نوار بالا", de: "Kopfleiste", es: "Barra superior", ar: "الشريط العلوي" },
  "ux.palette.search_aria": { fa: "جستجوی فرمان‌ها", de: "Befehle suchen", es: "Buscar comandos", ar: "بحث في الأوامر" },
  "ux.palette.list_aria": { fa: "فرمان‌ها", de: "Befehle", es: "Comandos", ar: "الأوامر" },
