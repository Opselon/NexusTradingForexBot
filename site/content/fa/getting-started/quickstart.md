...
> [حساب دمو → SHADOW → LIVE کوچک](#معنای-حالتها). کلمپ‌های سخت موتور از
> استراتژی محافظت می‌کنند — نه از سرمایه شما در برابر نوسان بازار.

## گام بعدی

- [نمای معماری](/fa/architecture/overview/)
- [وضعیت پروژه](/fa/project/status/)
- [پرسش‌های متداول](/reference/faq/)
